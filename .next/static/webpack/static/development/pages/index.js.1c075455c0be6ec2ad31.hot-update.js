  ...
  const setValue = () => {
    ...
    input.addEventListener("keydown", event => {
      if (event.keyCode === 13) {
        ...
        console.log("where" + newsInputContent);
