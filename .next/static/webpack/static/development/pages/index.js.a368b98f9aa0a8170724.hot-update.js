...
function Consumer() {
  ...
  const calc = (x, y) => [-(y - window.innerHeight / 2) / 330, (x - window.innerWidth / 2) / 120, 1.002];

  const trans = (x, y, s) => "perspective(1990px) rotateX(".concat(x, "deg) rotateY(").concat(y, "deg) scale(").concat(s, ")"); // 120 / 320 is a good setting
