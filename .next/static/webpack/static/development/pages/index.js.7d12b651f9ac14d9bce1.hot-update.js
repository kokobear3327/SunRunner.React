...
function Consumer() {
  ...
  const calc = (x, y) => [-(y - window.innerHeight / 2) / 280, (x - window.innerWidth / 2) / 280, 1.007];

  const trans = (x, y, s) => "perspective(690px) rotateX(".concat(x, "deg) rotateY(").concat(y, "deg) scale(").concat(s, ")");
