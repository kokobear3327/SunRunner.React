  ...
  const setValue = () => {
    ...
    inputForDashboard.addEventListener("keydown", event => {
      if (event.keyCode === 13) {
        ...
        document.inputForDashboard.remove();
      } // do something
