...
class BalloonWrench extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  componentDidMount() {
    ...
    function cursor(e) {
      ...
      let forty = 40;
      let val = pageX - forty;
      balloonCursor.item(0).style.top = e.pageY - 130 + 'px';
      balloonCursor.item(0).style.left = e.pageX - 570 + 'px';
    }
  }
...
//# sourceMappingURL=index.js.dbbd6144fab19134dc57.hot-update.js.map