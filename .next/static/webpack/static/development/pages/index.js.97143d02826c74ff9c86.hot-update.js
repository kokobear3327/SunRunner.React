...
function Dock(props) {
  ...
  inptSearch.addEventListener('focus', event => {
    document.querySelector(".search").addClass('active');
  });
  const {
    0: state,
    1: setState
