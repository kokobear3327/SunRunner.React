...
function Dock(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    ...
    document.querySelector("#inpt_search").on('focus', function () {
      this.parent('label').addClass('active');
