...
class BalloonWrench extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  componentDidMount() {
    ...
    function cursor(e) {
      ...
      let forty = 40;
      let val = pageX - forty;
      balloonCursor.item(0).style.top = e.pageY - 70 + 'px';
      balloonCursor.item(0).style.left = e.pageX - 555 + 'px';
    }
  }
...
//# sourceMappingURL=index.js.2ffc0b0639b5235f1d0d.hot-update.js.map