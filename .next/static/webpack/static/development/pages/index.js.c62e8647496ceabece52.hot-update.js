...
function NewsButton() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    ...
    newsButton.addEventListener("mouseover", () => {
      ...
      const worky = this.useSelector(state => state.isNews);
      console.log(worky);
    });
  });
  return __jsx("div", {
