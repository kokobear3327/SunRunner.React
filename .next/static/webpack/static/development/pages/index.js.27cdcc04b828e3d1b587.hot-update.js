  ...
  const setValue = () => {
    ...
    input.addEventListener("keydown", event => {
      if (event.keyCode === 13) {
        ...
        dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_5__["isNewsContent"])("hey"));
